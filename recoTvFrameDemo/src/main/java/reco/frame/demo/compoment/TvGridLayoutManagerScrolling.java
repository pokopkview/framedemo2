 ...
 */
public class TvGridLayoutManagerScrolling extends RecyclerView.LayoutManager {
     ...
     */
    private static final float MAX_SCROLL_FACTOR = 1 / 6f;
     ...
     */
    @SuppressWarnings("unused")
    public TvGridLayoutManagerScrolling(Context context, AttributeSet attrs, int defStyleAttr,
                                      int defStyleRes) {
     ...
     */
    public TvGridLayoutManagerScrolling(int spanCount, int orientation) {
    ...
    private int computeScrollOffset(RecyclerView.State state) {
        ...
        ensureOrientationHelper();
        return sbhelper.computeScrollOffset(state, mPrimaryOrientation,
    ...
    private int computeScrollExtent(RecyclerView.State state) {
        ...
        ensureOrientationHelper();
        return sbhelper.computeScrollExtent(state, mPrimaryOrientation,
                findFirstVisibleItemClosestToStart(!mSmoothScrollbarEnabled, true)
                , findFirstVisibleItemClosestToEnd(!mSmoothScrollbarEnabled, true),
    ...
    private int computeScrollRange(RecyclerView.State state) {
        ...
        ensureOrientationHelper();
        return sbhelper.computeScrollRange(state, mPrimaryOrientation,
                findFirstVisibleItemClosestToStart(!mSmoothScrollbarEnabled, true)
                , findFirstVisibleItemClosestToEnd(!mSmoothScrollbarEnabled, true),
                this, mSmoothScrollbarEnabled);
    }
...
//        }
    ...
    private void handleUpdate(int positionStart, int itemCountOrToPosition, int cmd) {
        ...
        final int affectedRangeEnd = 0;// exclusive
        final int affectedRangeStart = 0;// inclusive
