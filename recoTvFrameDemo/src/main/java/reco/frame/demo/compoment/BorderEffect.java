...
public class BorderEffect implements BorderView.Effect {
    ...
    public FocusListener absListViewFocusListener = new FocusListener() {
        ...
        public void onFocusChanged(View oldFocus, View newFocus) {
            ...
            try {
                ...
                if (oldFocus == null) {
                    System.out.println("oldFocus == null");
                    ...
                    System.out.println("oldFocus instanceof AbsListView && newFocus instanceof AbsListView");
    ...
    public void onFocusChanged(View target, View oldFocus, View newFocus) {
        if(oldFocus instanceof ImageView){
            System.out.println(oldFocus+"_________instanceof");
        try {
            Log.d(TAG, "onFocusChanged:" + oldFocus + "=" + newFocus);
...
//            Log.d(TAG, "onScrollChanged");
    ...
    public void onLayout(View target, View attachView) {
        try {
//            Log.d(TAG, "onLayout");
            System.out.println("_______onLayout");
